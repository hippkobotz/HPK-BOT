		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD HIDRA BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmão. Você não está registrado como amigo do meu dono hidra. Registre-se para fazer amizade com o bot Hidra por meio, \n\nComando : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Hidra|19\n\n──「 Hidra BOT 」──`,
			...
			const ownerNumber = ["553181030138@s.whatsapp.net","556796005372@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"553181030138@s.whatsapp.net","556796005372@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["553181030138@s.whatsapp.net","556796005372@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["553181030138@s.whatsapp.net","556796005372@s.whatsapp.net"]//ubah nomor lo
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("bot")){
			...
			if (messagesC.includes("botapanhou")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/botapanhou.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("botarrombado")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/botarrombado.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/botviado.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("carioca")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/carioca.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("comeuadm")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/comeuadm.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("comofezbot")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/comofezbot.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("diaazul")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/diaazul.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("donodogp")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/donodogp.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("egrilo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/egrilo.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			if (messagesC.includes("jacare")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/jacare.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("karolsemk")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/karolsemk.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("lemonhaze")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/lemonhaze.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("lilpeep")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/lilpeep.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("meupai")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/meupai.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("oniichan")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/oniichan.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("pessoalgp")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/pessoalgp.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("sad2")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/sad2.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("saidogp")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/saidogp.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("somhentai")){
			client.updatePresence(from, Presence.composing)
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/HIDRAjokes.js');
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO HIDRA BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @hidra domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `*MUSICA ENCONTRADA!*\nTítulo : ${anu.result.title}\nUrl : ${anu.result.source}\nTamanho : ${anu.result.size}\n\n*ESPERE UM POUCO ESTOU ENVIANDO O AUDIO*`
                buffer = await getBuffer(anu.result.thumbnail)
                lagu = await getBuffer(anu.result.url_audio)
                client.sendMessage(from, buffer, image, {quoted: mek, caption: infomp3})
                client.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', filename: `${anu.title}.mp3`, quoted: mek})
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é o Hidra Of Hype, slk o mano manja muito chama ele no pv pra quem não consegue ver o contato aqui em cima wa.me/+5567996005372 chama ele ai',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					case 'hidradmin':
					tod = await getBuffer(``)
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT HIDRA ✨* 」\n*│+ wa.me/556796005372*╰──────*「 *HIDRA* 」*────*\n\n*_SE QUER SER ADMIN DO BOT HIDRA_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do HIDRA:*\n\n Tem não'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* HIDRA\n*YOUTUBE:* Tem não\n*WPP:* wa.me/+556796005372\n*\n\nEspero que tenham gostado do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
